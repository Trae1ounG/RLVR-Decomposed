...
TRAIN_FILE=${TRAIN_FILE:-"/opt/tiger/entropy_grad/data/deepmath-5k.parquet"}
TEST_FILE=${TEST_FILE:-["/opt/tiger/entropy_grad/data/aime_2024.parquet","/opt/tiger/entropy_grad/data/aime_2025.parquet","/opt/tiger/entropy_grad/data/amc2023.parquet","/opt/tiger/entropy_grad/data/math500.parquet"]}
# Algorithm
temperature=1.0
top_p=1.0
...
experiment_name="Qwen3-8b_byte_grpo_deepmath5k_bsz128_mini32_n8_resp8k_higherclip0.2_lr1e-6$"
default_hdfs_dir=hdfs://haruna/home/byte_data_seed/hdd_hldy/user/tanyuqiao/experiments/${project_name}/${experiment_name}/
